  ...
  NB.onReady(function () {
    ...
    NB.observe(cvs, 7 / 4, ({ ctx, W, H }) => {
      ...
      labels.forEach((_, i) => {
        ...
        bar(center - gap / 2 - barW, y1, barW, h1, NB.colors.maroon);
        bar(center + gap / 2, y2, barW, h2, NB.colors.gold);
      });
      ...
      NB.setLegend(cvs.parentNode, [
        { label: "Delayed Buses", color: NB.colors.maroon },
        { label: "Total Buses", color: NB.colors.gold }
      ]);
