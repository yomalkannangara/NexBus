  ...
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a href="/A/routes" class="menu-item<?= ($module==='A' && $page==='routes') ? ' active' : '' ?>">
          <i class="icon"><svg xmlns="http://www.w3.org/2000/svg" class="lucide lucide-map" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/></svg></i>
          Routes
        </a>
