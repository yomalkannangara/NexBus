  ...
  <aside class="sidebar">
    ...
    <nav class="menu">
      ...
      <?php elseif ($module === 'TP'): ?>
        ...
        <a href="/TP/turn_management" class="menu-item<?= $active('TP','turn_management') ?>"><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg></i>Turn Management</a>
        ...
        <a href="/TP/messages"        class="menu-item<?= $active('TP','messages')        ?>"><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" class="lucide lucide-message-square" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></i>Messages</a>
      <?php elseif ($module === 'TS'): ?>
        ...
        <a href="/TS/turn_management" class="menu-item<?= $active('TS','turn_management') ?>"><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg></i>Turn Management</a>
        ...
        <a href="/TS/messages"       class="menu-item<?= $active('TS','messages')       ?>"><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" class="lucide lucide-message-square" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></i>Messages</a>
      <?php else: ?>
