...
<section class="filters-panel">
  <div class="filters-title">
    ...
    <?php if ($hasFilter): ?>
      <a href="/B/performance" class="filter-clear-link" title="Clear all filters">&#10005; Clear</a>
    <?php endif; ?>
  </div>

  <form method="get" action="/B/performance" class="filters-grid-3" id="analytics-filter-form">
    <!-- Route -->
    <div class="field">
...
<section class="kpi-wrap kpi-wrap--neo">
  ...
  <article class="kpi2 tone-green">
    ...
    <div class="value" id="kpi-rating"><?= $kpi['avgRating'] > 0 ? number_format((float)$kpi['avgRating'],1) : '&ndash;' ?></div>
  ...
  <article class="kpi2 tone-orange">
    ...
    <div class="value" id="kpi-speed"><?= (int)($kpi['speedViol'] ?? 0) ?: '&ndash;' ?></div>
...
<section class="kpi-wrap kpi-wrap--neo">
  <article class="kpi2 tone-blue">
    ...
    <div class="value" id="kpi-active-buses">&ndash;</div>
    <div class="hint" id="live-updated-at">Fetching&hellip;</div>
  </article>
  ...
  <article class="kpi2 tone-green">
    ...
    <div class="value" id="kpi-avg-speed">&ndash;</div>
...
<section class="charts-grid" style="margin-bottom:1.5rem">
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=live_status<?= $dq ?>">View Live Bus Status Details</a>
    <h2>Live Bus Status</h2>
    <canvas id="liveStatusChart" data-drill-key="live_status" data-drill-base="/B/reports/details"></canvas>
  </div>
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=live_speed<?= $dq ?>">View Live Fleet Speed Details</a>
    <h2>Live Fleet Speed</h2>
    <canvas id="liveSpeedChart" data-drill-key="live_speed" data-drill-base="/B/reports/details"></canvas>
  </div>
</section>
  ...
  <div style="overflow-x:auto">
    <table class="live-fleet-table">
      ...
      <tbody id="live-route-tbody">
        <tr><td colspan="6" class="nb-table-empty">Loading&hellip;</td></tr>
      </tbody>
    </table>
  </div>
</section>
...
<section class="charts-grid">
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=bus_status<?= $dq ?>">View Bus Status Details</a>
    <h2>Bus Status</h2>
    <canvas id="busStatusChart" data-drill-key="bus_status" data-drill-base="/B/reports/details"></canvas>
  </div>

  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=delayed_by_route<?= $dq ?>">View Delayed Route Details</a>
  ...
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=speed_by_bus<?= $dq ?>">View Speed Violation Details</a>
  ...
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=revenue<?= $dq ?>">View Revenue Details</a>
    <h2>Revenue</h2>
    <canvas id="revenueChart" data-drill-key="revenue" data-drill-base="/B/reports/details"></canvas>
  </div>

  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=wait_time<?= $dq ?>">View Wait Time Details</a>
  ...
  <div class="chart-card" style="position:relative">
    <a class="js-chart-detail-btn" style="position:absolute;top:10px;right:10px;z-index:2" href="/B/reports/details?chart=complaints_by_route<?= $dq ?>">View Complaint Details</a>
