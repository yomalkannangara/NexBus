...
<section id="earningsPage" data-endpoint="<?= BASE_URL; ?>/earnings">
  ...
  <header class="page-header">
    ...
    <div class="header-actions">
      <button type="button" class="export-report-btn-alt js-export" data-export-href="<?= BASE_URL; ?>/earnings/export">
        Export Report
      </button>
        ...
        <tbody>
          <?php if (!empty($earnings)): ?>
            <?php foreach ($earnings as $e): ?>
              ...
              ?>
              <tr data-date="<?= htmlspecialchars($row['date']) ?>" data-bus="<?= htmlspecialchars($row['bus_reg_no']) ?>"
                ...
                <td>
                  <div class="action-buttons">
                    <button type="button" class="icon-btn icon-btn-edit js-earning-edit" title="Edit"
                    ...
                    <button type="button" class="icon-btn icon-btn-delete js-earning-del" title="Delete"
  ...
  <div id="deleteConfirmModal" class="modal" hidden>
    ...
    <div class="modal__dialog" style="max-width: 400px; padding: 0;">
      ...
      <div class="modal__form" style="padding-top: 10px;">
        <p style="color: #4B5563; font-size: 15px; margin: 0;">Are you sure you want to delete this earning record? This
...
<style>
  ...
  .enrg-kpi-card--revenue .enrg-kpi-card__icon {
    background: #D1FAE5;
    color: #065F46;
  }

  .enrg-kpi-card--expense .enrg-kpi-card__icon {
    background: #FEE2E2;
    color: #991B1B;
  }

  .enrg-kpi-card--route .enrg-kpi-card__icon {
    background: #FEF3C7;
    color: #92400E;
  }

  .enrg-kpi-card--buses .enrg-kpi-card__icon {
    background: #F5D6E0;
    color: #7F0032;
  }
  ...
  .enrg-kpi-card__glow--green {
    background: #10B981;
  }

  .enrg-kpi-card__glow--red {
    background: #EF4444;
  }

  .enrg-kpi-card__glow--gold {
    background: #F59E0B;
  }

  .enrg-kpi-card__glow--maroon {
    background: #7F0032;
  }
  ...
  .enrg-modal__btn--cancel {
    background: #F3F4F6;
    color: #374151;
    border: 1px solid #E5E7EB;
  }

  .enrg-modal__btn--cancel:hover {
    background: #E5E7EB;
  }

  .enrg-modal__btn--submit {
    background: var(--gold);
    color: var(--maroon);
  }

  .enrg-modal__btn--submit:hover {
    background: #F59E0B;
  }
