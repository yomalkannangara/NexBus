<?php
// Depot Manager Feedback (SLTB buses)
...
<section id="feedbackPage">
  ...
  <header class="page-header">
    <div>
      ...
      <p class="page-subtitle">SLTB buses at your depot</p>
    </div>
  </header>
    ...
    <div class="fb-card js-fb-card"
      ...
      <div class="fb-card__footer">
        ...
        <span class="fb-card__replied">
          <svg width="12" height="12" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" stroke-linecap="round" d="M3 10a7 7 0 0114 0V6a7 7 0 00-14 0v4zm11 0v4a4 4 0 01-8 0v-4"/></svg>
          Replied
        </span>
        <?php endif; ?>
    ...
    <div class="fb-modal__panel" role="dialog" aria-modal="true" aria-labelledby="fb-modal-title">
      ...
      <div class="fb-modal__body">
        ...
        <div class="fb-modal__section" id="fb-existing-reply-section">
          <div class="fb-modal__section-title">
            <svg width="15" height="15" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" stroke-linecap="round" d="M3 10a7 7 0 0114 0V6a7 7 0 00-14 0v4zm11 0v4a4 4 0 01-8 0v-4"/></svg>
            Previous Reply
          </div>
        ...
        <div class="fb-modal__section">
          ...
          <form method="post" action="/M/feedback" id="fb-reply-form">
