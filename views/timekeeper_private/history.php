...
<div class="tke-hist-filter">
    <form method="get" action="/TP/history">
...
<div class="tke-card">
    <div class="tke-card-head">
        ...
        <span class="meta">
            ...
            &nbsp;&middot;&nbsp;<span id="tkeAutoRefreshLabel" style="font-size:.7rem;opacity:.75;">Auto-refresh in <span id="tkeCountdown">30</span>s</span>
            <?php endif; ?>
        </span>
    </div>
    <div class="tke-wrap">
    <table class="tke-table">
        ...
        <tr>
            ...
            <td><a class="bus-link" href="/TP/dashboard?focus_bus=<?= urlencode((string)($hr['bus_reg_no'] ?? '')) ?>">
