...
public function depot(int $depotId): ?array {
    ...
    public function attendanceSavedAt(int $depotId, string $date): ?string { return $this->att->savedAt($depotId, $date); }
    public function attendanceTrend(int $depotId, string $from, string $to, ?string $akey = null, ?string $role = null): array { return $this->att->trendByDay($depotId, $from, $to, $akey, $role); }
